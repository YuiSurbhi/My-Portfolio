...
const Projects = () => {
  return (
    <div 
      ...
      {/* Main Content */}
      <div className="flex-1 p-12 left-10 relative">
        {/* Heading */}
        <h1 className="text-[4rem] md:text-[8rem] font-extrabold uppercase tracking-widest relative inline-block z-10">
      ...
      <div className="flex flex-wrap gap-6 mt-0 ml-10 justify-center items-start">
        ...
        <img
          ...
          className="absolute bottom-0 right-40 w-[350px] md:w-[380px] z-20"
        />
      </div>
    </div>
  );
